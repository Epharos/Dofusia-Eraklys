...
import fr.eraklys.jobs.capability.DefaultPlayerJobsStorage;
import fr.eraklys.jobs.capability.IPlayerJobs;
import fr.eraklys.jobs.capability.PlayerJobsHolder;
...
public class CapabilitiesRegisterer 
{
	public static void registerCapabilities()
	{
		...
		CapabilityManager.INSTANCE.register(IPlayerJobs.class, new DefaultPlayerJobsStorage(), PlayerJobsHolder::new);
	}
}
